...
-- RBAC
    ...
    grant insert( color_1, color_2, font, logo, placeholder, rich_text, short_text, header_mail_name, header_mail_contact,award_winning_asso_list) on publ.event_brandings to :DATABASE_VISITOR;
...
-- fixtures
  -- fixtures go here
    ...
    insert into publ.events (id, city, name, description, capacity, organization_id, starts_at,ends_at, booking_starts_at ,booking_ends_at) values ('3d370256-eb3c-42ce-9e8f-fa4dda7ab0fa','Nantes', 'Third', 'Ceci est la description de l''événement third, but de l''événement, contenu de l''événement etc', 250, (select id from publ.organizations where name = 'Grinn'),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')));
    insert into publ.events (id, city, name, description, organization_id, starts_at,ends_at, booking_starts_at ,booking_ends_at) values ('ce860692-57ef-4905-848d-3e22302a6fea','Nantes', 'test', 'test', (select id from publ.organizations where name = 'Grinn'),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')));

    insert into publ.events (id, city, name, description, organization_id, starts_at,ends_at, booking_starts_at ,booking_ends_at) values ('347687ee-e455-4041-a3e0-ccf484149785', 'Paris','second test', 'second test', (select id from publ.organizations where name = 'Grinn'),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),'2023-02-20 20:00:00','2023-12-20 20:00:00');
    insert into publ.events (id, city, name, description, organization_id, starts_at,ends_at, booking_starts_at ,booking_ends_at) values ('1f12aafb-349e-47b6-bc70-d930edd1a329', 'Paris','gfhdfgh', 'gfhdfgh', (select id from publ.organizations where name = 'Grinn'),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')));
    insert into publ.events (id, city, name, description, organization_id, starts_at,ends_at, booking_starts_at ,booking_ends_at) values ('8ab9e304-f321-4a9d-bfdf-47773a97ff04', 'Paris','wxcvcxv', 'wxcvcxv', (select id from publ.organizations where name = 'Grinn'),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')));
    insert into publ.events (id, city, name, description, organization_id, starts_at,ends_at, booking_starts_at ,booking_ends_at) values ('3844c7d0-a1a2-48e7-bd70-fd771a189f12', 'Paris','azdaz', 'azdaz', (select id from publ.organizations where name = 'Grinn'),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')),(select timestamp '2023-05-10 20:00:00' + random() * (timestamp '2023-05-20 20:00:00' - timestamp '2023-05-10 10:00:00')));
