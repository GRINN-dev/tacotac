  ...
  return (
    <div className="flex flex-col w-full">
      ...
      {currentDate < bookingStartsAt ? (
        <span className="text-red-500">La réservation n&apos;est pas encore ouverte.</span>
      ) : (
        <>
                                    ...
                                    <Select value={value} onValueChange={onChange} required={true}>
                                      ...
                                      <SelectContent>
                                        <SelectGroup>
                                          ...
                                          <SelectItem value={"par le bouche à oreille"}>
                                            Par le bouche à oreille
                                          </SelectItem>
                                          <SelectItem
                                            value={"par la Fondation de France, co-organisateur de l''événement"}
                                          >
